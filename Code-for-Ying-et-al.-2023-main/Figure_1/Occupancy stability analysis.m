...
%% stats 
load('workspace_for_occupancy_analysis.mat')
% the occupancy version of the stability analysis takes a while to run,
% feel free to load in this workspace which is what you would get had you
% run the above code
